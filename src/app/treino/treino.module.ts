...
import { ExercicioItemComponent } from './components/exercicio-item/exercicio-item.component';
...
@NgModule({
  declarations: [TreinoPageComponent, TreinoItemComponent, ExercicioItemComponent, TreinoDetailPageComponent, MicrocicloItemComponent],
  imports: [
    CommonModule,
    TreinoRoutingModule,
    YouTubePlayerModule,
